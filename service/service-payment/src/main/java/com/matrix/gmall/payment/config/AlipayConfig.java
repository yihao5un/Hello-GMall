package com.matrix.gmall.payment.config;
...
/**
 * AlipayConfig 配置类
 * classpath：指的是resource目录，指明读取哪个配置文件
 *
 * @author yihaosun
 * @date 2022/2/7 17:27
 */
...
public class AlipayConfig {
    ...
    public AlipayClient alipayClient() {
        AlipayClient alipayClient = new DefaultAlipayClient(alipayUrl, appId, appPrivateKey, format, charset, alipay_public_key, sign_type);
        return alipayClient;
    }
}
